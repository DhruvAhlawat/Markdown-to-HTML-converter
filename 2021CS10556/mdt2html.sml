            ...
            in 
                ...
                then
                    ...
                    let 
                        ...
                        val idk = TextIO.output(outs,"<p>");
                        val (bl,cl,dl,el) = ListHandler(#3 isListItem,#2 isListItem,1,c,d,e); (*#3 isListItem denotes the type of list,ol or ul*)
            ...
            in
                ...
                (*is a list*)
                    ...
                    then let
                        ...
                        val idk = TextIO.output(outs,"<p>");
                        val (b1,cl,dl,el) = ListHandler(#3 isListItem,#2 isListItem,1,c,d,e);
                    in
...
(*mdt2html "README"; (*README doesnt work as it is a .md file instead of .mdt, but change the name and it should work well*)
mdt2html "ExampleFile"; 
mdt2html "InputMarkdown"; *)
